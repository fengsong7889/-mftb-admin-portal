...
export const DEFAULT_RULE_GROUPS: RuleGroup[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      { key: 'eam_purchase_order', label: '採購訂單編號', type: 'table', value: 'DDCG', defaultValue: 'DDCG', dateFormat: 'YYYYMMDD', min: 4, max: 4, unit: 'DDCG202609140000', remark: '{prefix} + YYYYMMDD + {n}位自增序號', menu: '物資管理-採購執行' },
      { key: 'eam_inbound_batch', label: '驗收入庫批次編號', type: 'table', value: 'IB', defaultValue: 'IB', dateFormat: 'YYYYMMDD', min: 4, max: 4, unit: 'IB202609160000', remark: '{prefix} + YYYYMMDD + {n}位自增序號', menu: '物資管理-驗收入庫' },
      ...
      { key: 'eam_consumable_inbound', label: '耗材入庫單號', type: 'table', value: 'HCRK', defaultValue: 'HCRK', dateFormat: 'YYYYMMDD', min: 4, max: 4, unit: 'HCRK202609180000', remark: '{prefix} + YYYYMMDD + {n}位自增序號', menu: '物資管理-耗材入庫' },
      { key: 'eam_consumable_return', label: '耗材退料單號', type: 'table', value: 'HCTL', defaultValue: 'HCTL', dateFormat: 'YYYYMMDD', min: 4, max: 4, unit: 'HCTL202609180000', remark: '{prefix} + YYYYMMDD + {n}位自增序號', menu: '物資管理-耗材領用' },
      { key: 'eam_consumable_adjust', label: '耗材調整單號', type: 'table', value: 'HCTZ', defaultValue: 'HCTZ', dateFormat: 'YYYYMMDD', min: 4, max: 4, unit: 'HCTZ202609180000', remark: '{prefix} + YYYYMMDD + {n}位自增序號', menu: '物資管理-耗材庫存' },
      { key: 'eam_consumable_transfer', label: '耗材調撥單號', type: 'table', value: 'HCDB', defaultValue: 'HCDB', dateFormat: 'YYYYMMDD', min: 4, max: 4, unit: 'HCDB202609180000', remark: '{prefix} + YYYYMMDD + {n}位自增序號', menu: '物資管理-耗材庫存' },
