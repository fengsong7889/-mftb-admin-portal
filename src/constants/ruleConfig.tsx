...
export const DEFAULT_RULE_GROUPS: RuleGroup[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      { key: 'eam_location_warehouse', label: '倉庫編碼', type: 'table', value: 'CK-', defaultValue: 'CK-', dateFormat: '', min: 3, max: 3, unit: 'CK-000', remark: 'CK- + 3位數字自增（全局自增，如 CK-001、CK-002）', menu: '物資管理(EAM)-基礎配置' },
