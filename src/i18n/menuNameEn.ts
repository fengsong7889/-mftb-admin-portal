...
export const MENU_NAME_EN: Record<string, string> = {
  ...
  'hr-profile': 'Employee Profile',
  'hr-lifecycle': 'Employee Lifecycle',
  'hr-config': 'HR Config',
  'hr-onboarding': 'Onboarding',
  'hr-regularization': 'Regularization',
  'hr-transfer': 'Transfer',
  'hr-dimission': 'Dimission',
  'ess-center': 'Employee Self-Service',
  'ess-leave': 'My Leave',
  ...
  'org-center': 'Organization Management',
  'org-structure': 'Department Structure',
  ...
  // 權限管理（功能授權/系統授權已合并為授權中心，旧 key 保留至菜單物理清理）
  ...
  'rule-config': 'Rule Overview',
  'rule-center': 'Rule Center',
  'rule-ad-sales': 'Ad Sales Rules',
  'rule-gift': 'Gift Rules',
  'rule-security': 'Security Rules',
  'rule-algorithm': 'Algorithm Rules',
  'rule-seq': 'ID Sequence Rules',
