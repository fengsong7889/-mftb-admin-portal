...
export default function HotSearchReport() {
  ...
  const columns: TableColumnsType<ReportData> = [
    ...
    { title: t('hotSearchReport.colShowCount'), dataIndex: 'showCount', key: 'showCount', width: 100, align: 'right' as const, sorter: true },
    { title: t('hotSearchReport.colClickCount'), dataIndex: 'clickCount', key: 'clickCount', width: 100, align: 'right' as const, sorter: true },
    { title: t('hotSearchReport.colClickRate'), dataIndex: 'clickRate', key: 'clickRate', width: 100, align: 'right' as const, sorter: true },
    { title: t('hotSearchReport.colShopVisit'), dataIndex: 'shopVisitCount', key: 'shopVisitCount', width: 120, align: 'right' as const, sorter: true },
    {
