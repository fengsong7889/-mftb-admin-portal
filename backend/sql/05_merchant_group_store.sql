...
-- 示例赠送记录
INSERT INTO biz_gift_record (gift_id, group_id, group_name, store_id, store_name, brand, ad_type, total_days, valid_days, used_days, remaining_days, gift_date, expire_date, status, reason, applicant, apply_time, approval_status)
SELECT '2401-001', g.id, '美味餐廳集團', s.id, '澳門總店', '2', 'new_store', 30, 180, 12, 18, '2024-01-15', '2024-07-15', 1, '新集團入駐扶持', '張三', '2024-01-15 10:30:00', 2
FROM biz_merchant_group g, biz_store s WHERE g.group_code = 'JT000001' AND s.store_code = 'MD00001'
AND NOT EXISTS (SELECT 1 FROM biz_gift_record WHERE gift_id = '2401-001');

INSERT INTO biz_gift_record (gift_id, group_id, group_name, store_id, store_name, brand, ad_type, total_days, valid_days, used_days, remaining_days, gift_date, expire_date, status, reason, applicant, apply_time, approval_status)
SELECT '2310-001', g.id, '生鮮超市集團', s.id, '氹仔分店', '1', 'revival', 60, 180, 60, 0, '2023-10-01', '2024-04-01', 2, '集團盤活復蘇計劃', '李四', '2023-10-01 14:20:00', 2
FROM biz_merchant_group g, biz_store s WHERE g.group_code = 'JT000002' AND s.store_code = 'MD00002'
AND NOT EXISTS (SELECT 1 FROM biz_gift_record WHERE gift_id = '2310-001');

INSERT INTO biz_gift_record (gift_id, group_id, group_name, store_id, store_name, brand, ad_type, total_days, valid_days, used_days, remaining_days, gift_date, expire_date, status, reason, applicant, apply_time, approval_status)
SELECT '2401-003', g.id, '時尚百貨集團', s.id, '新馬路店', '2', 'exclusive', 90, 365, 45, 45, '2024-01-01', '2024-12-31', 1, '大促活動支持', '王五', '2024-01-01 09:15:00', 2
FROM biz_merchant_group g, biz_store s WHERE g.group_code = 'JT000003' AND s.store_code = 'MD00003'
AND NOT EXISTS (SELECT 1 FROM biz_gift_record WHERE gift_id = '2401-003');

INSERT INTO biz_gift_record (gift_id, group_id, group_name, store_id, store_name, brand, ad_type, total_days, valid_days, used_days, remaining_days, gift_date, expire_date, status, reason, applicant, apply_time, approval_status)
SELECT '2306-001', g.id, '速遞物流集團', s.id, '黑沙環店', '1', 'new_store', 15, 90, 0, 15, '2023-06-01', '2023-12-01', 3, '合作夥伴獎勵', '趙六', '2023-06-01 11:00:00', 2
FROM biz_merchant_group g, biz_store s WHERE g.group_code = 'JT000004' AND s.store_code = 'MD00004'
AND NOT EXISTS (SELECT 1 FROM biz_gift_record WHERE gift_id = '2306-001');

INSERT INTO biz_gift_record (gift_id, group_id, group_name, store_id, store_name, brand, ad_type, total_days, valid_days, used_days, remaining_days, gift_date, expire_date, status, reason, applicant, apply_time, approval_status)
SELECT '2401-004', g.id, '甜品屋集團', s.id, '官也街老店', '2', 'new_store', 7, 30, 0, 0, NULL, NULL, 1, '新集團開業扶持', '關羽', '2024-01-20 16:30:00', 1
FROM biz_merchant_group g, biz_store s WHERE g.group_code = 'JT000005' AND s.store_code = 'MD00005'
AND NOT EXISTS (SELECT 1 FROM biz_gift_record WHERE gift_id = '2401-004');

INSERT INTO biz_gift_record (gift_id, group_id, group_name, store_id, store_name, brand, ad_type, total_days, valid_days, used_days, remaining_days, gift_date, expire_date, status, reason, applicant, apply_time, approval_status)
SELECT '2401-005', g.id, '火鍋城集團', s.id, '珠海旗艦店', '1', 'ka', 14, 60, 0, 0, NULL, NULL, 1, '集團盤活復蘇計劃', '張飛', '2024-01-18 09:45:00', 3
FROM biz_merchant_group g, biz_store s WHERE g.group_code = 'JT000006' AND s.store_code = 'MD00006'
AND NOT EXISTS (SELECT 1 FROM biz_gift_record WHERE gift_id = '2401-005');

-- 示例消费流水
INSERT INTO biz_gift_consume (gift_record_id, gift_id, group_id, group_name, store_id, store_name, brand, ad_type, trade_type, balance_change, change_date, algorithm_id, algorithm_name, order_no, remaining_days, remark)
SELECT gr.id, gr.gift_id, gr.group_id, gr.group_name, gr.store_id, gr.store_name, gr.brand, gr.ad_type, 'ad_purchase', -5, '2024-02-10', 'A001', '新店廣告-外賣版', 'AD202402100001', 25, ''
FROM biz_gift_record gr WHERE gr.gift_id = '2401-001'
AND NOT EXISTS (SELECT 1 FROM biz_gift_consume WHERE gift_id = '2401-001' AND trade_type = 'ad_purchase' AND change_date = '2024-02-10');

INSERT INTO biz_gift_consume (gift_record_id, gift_id, group_id, group_name, store_id, store_name, brand, ad_type, trade_type, balance_change, change_date, algorithm_id, algorithm_name, order_no, remaining_days, remark)
SELECT gr.id, gr.gift_id, gr.group_id, gr.group_name, gr.store_id, gr.store_name, gr.brand, gr.ad_type, 'ad_refund', 3, '2024-02-15', 'A001', '新店廣告-首頁版', 'AD202402150002', 28, ''
FROM biz_gift_record gr WHERE gr.gift_id = '2401-001'
AND NOT EXISTS (SELECT 1 FROM biz_gift_consume WHERE gift_id = '2401-001' AND trade_type = 'ad_refund' AND change_date = '2024-02-15');

INSERT INTO biz_gift_consume (gift_record_id, gift_id, group_id, group_name, store_id, store_name, brand, ad_type, trade_type, balance_change, change_date, algorithm_id, algorithm_name, order_no, remaining_days, remark)
SELECT gr.id, gr.gift_id, gr.group_id, gr.group_name, gr.store_id, gr.store_name, gr.brand, gr.ad_type, 'ad_purchase', -10, '2023-11-05', 'A002', '盤活復蘇-團購版', 'AD202311050001', 20, ''
FROM biz_gift_record gr WHERE gr.gift_id = '2310-001'
AND NOT EXISTS (SELECT 1 FROM biz_gift_consume WHERE gift_id = '2310-001' AND trade_type = 'ad_purchase' AND change_date = '2023-11-05');

INSERT INTO biz_gift_consume (gift_record_id, gift_id, group_id, group_name, store_id, store_name, brand, ad_type, trade_type, balance_change, change_date, algorithm_id, algorithm_name, order_no, remaining_days, remark)
SELECT gr.id, gr.gift_id, gr.group_id, gr.group_name, gr.store_id, gr.store_name, gr.brand, gr.ad_type, 'manual_deduct', -8, '2024-01-20', 'A003', '獨家商家-超市版', '—', 37, '商家違規進行虛假宣傳，經運營主管審核手動扣除贈送天數作為懲罰。'
FROM biz_gift_record gr WHERE gr.gift_id = '2401-003'
AND NOT EXISTS (SELECT 1 FROM biz_gift_consume WHERE gift_id = '2401-003' AND trade_type = 'manual_deduct' AND change_date = '2024-01-20');

INSERT INTO biz_gift_consume (gift_record_id, gift_id, group_id, group_name, store_id, store_name, brand, ad_type, trade_type, balance_change, change_date, algorithm_id, algorithm_name, order_no, remaining_days, remark)
SELECT gr.id, gr.gift_id, gr.group_id, gr.group_name, gr.store_id, gr.store_name, gr.brand, gr.ad_type, 'auto_expire', -7, '2024-03-01', 'A004', '金牌商家-全渠道', '—', 8, '贈送天數有效期到期，系統自動收回剩餘天數。'
FROM biz_gift_record gr WHERE gr.gift_id = '2306-001'
AND NOT EXISTS (SELECT 1 FROM biz_gift_consume WHERE gift_id = '2306-001' AND trade_type = 'auto_expire' AND change_date = '2024-03-01');

INSERT INTO biz_gift_consume (gift_record_id, gift_id, group_id, group_name, store_id, store_name, brand, ad_type, trade_type, balance_change, change_date, algorithm_id, algorithm_name, order_no, remaining_days, remark)
SELECT gr.id, gr.gift_id, gr.group_id, gr.group_name, gr.store_id, gr.store_name, gr.brand, gr.ad_type, 'ad_refund', 4, '2024-02-28', 'A005', '人氣商家-首頁版', 'AD202402280001', 14, ''
FROM biz_gift_record gr WHERE gr.gift_id = '2401-004'
AND NOT EXISTS (SELECT 1 FROM biz_gift_consume WHERE gift_id = '2401-004' AND trade_type = 'ad_refund' AND change_date = '2024-02-28');
